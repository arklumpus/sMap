...
First of all, you will need to download the sMap source code: [sMap-1.0.2.tar.gz](https://github.com/arklumpus/sMap/archive/v1.0.2.tar.gz) and extract it somewhere.
