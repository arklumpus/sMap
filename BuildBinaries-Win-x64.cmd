...
scsigntool -pin %certpin% sign /fd sha256 /n %certsub% /tr "http://ts.ssl.com" /td sha256 /v /a /d "sMap: Evolution of Independent, Dependent and Conditioned Discrete Characters in a Bayesian Framework" /du "https://github.com/arklumpus/sMap" !currcmd! || goto retry
